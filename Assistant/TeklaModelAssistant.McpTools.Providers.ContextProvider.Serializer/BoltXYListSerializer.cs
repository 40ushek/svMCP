...
{
	internal class BoltXYListSerializer : ISerializer
	{
		...
		{
			return Serialize((BoltXYList)obj, maxDepth, prefix, visited, ignorePropList, filterPropList);
		}

		private Dictionary<PropertyTypeEnum, Dictionary<string, string>> Serialize(BoltXYList bolt, int maxDepth = 2, string prefix = "", [System.Runtime.CompilerServices.Nullable(new byte[] { 2, 0 })] HashSet<object> visited = null, [System.Runtime.CompilerServices.Nullable(new byte[] { 2, 0 })] HashSet<string> ignorePropList = null, [System.Runtime.CompilerServices.Nullable(new byte[] { 2, 0 })] HashSet<string> filterPropList = null)
		{
			...
			dictionary[PropertyTypeEnum.MODIFIABLE][text3 + "Bolt Dist X"] = text;
			dictionary[PropertyTypeEnum.MODIFIABLE][text3 + "Bolt Dist Y"] = text2;
			return dictionary;
		}
	}
}
