...
public sealed class DimensionOrchestrationDebugBuilderTests
{
    ...
    public void Build_UsesDecisionContextViewAndWarningsWhenViewArgumentIsMissing()
    {
        ...
        Assert.Equal(TeklaMcpServer.Api.Drawing.Dimensions.DimensionPlacementSettings.DefaultPaperGapMm, result.Packets[0].Evidence.TargetPartsBoundsGapPaper, 3);
        Assert.Equal(TeklaMcpServer.Api.Drawing.Dimensions.DimensionPlacementSettings.DefaultPaperGapMm, result.Packets[0].Evidence.TargetPartsBoundsGapDrawing, 3);
