...
public static partial class ModelTools
{
    ...
    public static string GetViewDimensionContext(
        ...
        [Description("Comma-separated questions: points, dimensionPoints, chain, edges, parts, scale, placement, contacts, or all. dimensionPoints returns point IDs without coordinates; chain previews standard chains; contacts, dimensionPoints and chain are opt-in and excluded from 'all'.")] string questions = "points,edges,scale",
