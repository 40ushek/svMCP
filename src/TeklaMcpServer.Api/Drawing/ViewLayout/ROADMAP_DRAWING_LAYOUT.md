...
На масштабе `1:10` три секции (~88×85мм каждая) выстраиваются в горизонтальную
линию слева от FrontView. Суммарная ширина `~238мм` + FrontView `493мм` = `~740мм`
— не влезает в `821мм`. `SCALE_CANDIDATE_REJECT scale=1:10 reason=no-fit(4778:SectionView)`.
