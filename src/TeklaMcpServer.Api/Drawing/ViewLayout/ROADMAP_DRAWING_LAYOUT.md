...
Каждый сценарий строит независимый виртуальный layout candidate или возвращает
reject reason. Это не полный перебор всех перестановок, а фиксированный
детерминированный набор проходов, который можно объяснить в trace.
